...
<el-table-column label="分量" prop="size" show-overflow-tooltip align='center'></el-table-column>
<el-table-column label="口味" prop="taste" show-overflow-tooltip align='center'></el-table-column>
<el-table-column label="单价(元)" prop="price" show-overflow-tooltip align='center'></el-table-column>
<el-table-column label="剩余(份)" prop="remain" show-overflow-tooltip align='center'></el-table-column>
  </el-table>
</div>
</template>
