const city = [
	{id: 1, name: '北京', city: [
		{id: 1, name: '东城区' , district : []},
		{id: 2, name: '西城区' , district : []},
		{id: 3, name: '崇文区' , district : []},
		{id: 4, name: '宣武区' , district : []},
		{id: 5, name: '朝阳区' , district : []},
		{id: 6, name: '丰台区' , district : []},
		{id: 7, name: '石景山区' , district : []},
		{id: 8, name: '海淀区' , district : []},
		{id: 9, name: '门头沟区' , district : []},
		{id: 10, name: '房山区' , district : []},
		{id: 11, name: '通州区' , district : []},
		{id: 12, name: '顺义区' , district : []},
		{id: 13, name: '昌平区' , district : []},
		{id: 14, name: '大兴区' , district : []},
		{id: 15, name: '怀柔区' , district : []},
		{id: 16, name: '平谷区' , district : []},
		{id: 17, name: '密云县' , district : []},
		{id: 18, name: '延庆县' , district : []}
	]},
	{id: 2, name: '天津', city: [
		{id: 19, name: '和平区' , district : []},
		{id: 20, name: '河东区' , district : []},
		{id: 21, name: '河西区' , district : []},
		{id: 22, name: '南开区' , district : []},
		{id: 23, name: '河北区' , district : []},
		{id: 24, name: '红桥区' , district : []},
		{id: 25, name: '塘沽区' , district : []},
		{id: 26, name: '汉沽区' , district : []},
		{id: 27, name: '大港区' , district : []},
		{id: 28, name: '东丽区' , district : []},
		{id: 29, name: '西青区' , district : []},
		{id: 30, name: '津南区' , district : []},
		{id: 31, name: '北辰区' , district : []},
		{id: 32, name: '武清区' , district : []},
		{id: 33, name: '宝坻区' , district : []},
		{id: 34, name: '宁河县' , district : []},
		{id: 35, name: '静海县' , district : []},
		{id: 36, name: '蓟县' , district : []}
	]},
	{id: 3, name: '河北', city: [
	...
	{id: 9, name: '上海', city: [
		{id: 719, name: '黄浦区' , district : []},
		{id: 720, name: '卢湾区' , district : []},
		{id: 721, name: '徐汇区' , district : []},
		{id: 722, name: '长宁区' , district : []},
		{id: 723, name: '静安区' , district : []},
		{id: 724, name: '普陀区' , district : []},
		{id: 725, name: '闸北区' , district : []},
		{id: 726, name: '虹口区' , district : []},
		{id: 727, name: '杨浦区' , district : []},
		{id: 728, name: '闵行区' , district : []},
		{id: 729, name: '宝山区' , district : []},
		{id: 730, name: '嘉定区' , district : []},
		{id: 731, name: '浦东新区' , district : []},
		{id: 732, name: '金山区' , district : []},
		{id: 733, name: '松江区' , district : []},
		{id: 734, name: '青浦区' , district : []},
		{id: 735, name: '南汇区' , district : []},
		{id: 736, name: '奉贤区' , district : []},
		{id: 737, name: '崇明县' , district : []}
	]},
	{id: 10, name: '江苏', city: [
	...
	{id: 22, name: '重庆', city: [
		{id: 2000, name: '万州区' , district : []},
		{id: 2001, name: '涪陵区' , district : []},
		{id: 2002, name: '渝中区' , district : []},
		{id: 2003, name: '大渡口区' , district : []},
		{id: 2004, name: '江北区' , district : []},
		{id: 2005, name: '沙坪坝区' , district : []},
		{id: 2006, name: '九龙坡区' , district : []},
		{id: 2007, name: '南岸区' , district : []},
		{id: 2008, name: '北碚区' , district : []},
		{id: 2009, name: '万盛区' , district : []},
		{id: 2010, name: '双桥区' , district : []},
		{id: 2011, name: '渝北区' , district : []},
		{id: 2012, name: '巴南区' , district : []},
		{id: 2013, name: '黔江区' , district : []},
		{id: 2014, name: '长寿区' , district : []},
		{id: 2015, name: '綦江县' , district : []},
		{id: 2016, name: '潼南县' , district : []},
		{id: 2017, name: '铜梁县' , district : []},
		{id: 2018, name: '大足县' , district : []},
		{id: 2019, name: '荣昌县' , district : []},
		{id: 2020, name: '璧山县' , district : []},
		{id: 2021, name: '梁平县' , district : []},
		{id: 2022, name: '城口县' , district : []},
		{id: 2023, name: '丰都县' , district : []},
		{id: 2024, name: '垫江县' , district : []},
		{id: 2025, name: '武隆县' , district : []},
		{id: 2026, name: '忠县' , district : []},
		{id: 2027, name: '开县' , district : []},
		{id: 2028, name: '云阳县' , district : []},
		{id: 2029, name: '奉节县' , district : []},
		{id: 2030, name: '巫山县' , district : []},
		{id: 2031, name: '巫溪县' , district : []},
		{id: 2032, name: '石柱土家族自治县' , district : []},
		{id: 2033, name: '秀山土家族苗族自治县' , district : []},
		{id: 2034, name: '酉阳土家族苗族自治县' , district : []},
		{id: 2035, name: '彭水苗族土家族自治县' , district : []},
		{id: 2036, name: '江津市' , district : []},
		{id: 2037, name: '合川市' , district : []},
		{id: 2038, name: '永川市' , district : []},
		{id: 2039, name: '南川市' , district : []}
	]},
	{id: 23, name: '四川', city: [
	...
	{id: 32, name: '港澳', city: [
		...
		{id: 343, name: '澳门特别行政区', district: [
			{id:2883 , name:'澳门特别行政区'},
			{id:2884 , name:'澳门半岛'},
			{id:2885 , name:'凼仔'},
			{id:2886 , name:'路凼城'},
			{id:2887 , name:'路环'}
